...
export const flightSafetySearch = (keyword, token) => (dispatch) => {
  if (keyword.length > 3) {
    dispatch(listFile(token, "flight-safety", 1, ()=>{}, keyword));
  } else if (keyword.length === 0) {
    dispatch(listFile(token, "flight-safety", 1, ()=>{}, "#erased-search*-value"));
  }
};
