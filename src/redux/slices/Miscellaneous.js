...
export const miscellaneousSearch = (keyword, token) => (dispatch) => {
  if (keyword.length > 3) {
    dispatch(listFile(token, "miscellaneous", 1, ()=>{}, keyword));
  } else if (keyword.length === 0) {
    dispatch(listFile(token, "miscellaneous", 1, ()=>{}, "#erased-search*-value"));
  }
};
